...
{
    "prodID" : 3,
    "prodType" : "Hoverskates",
    "prodPrice" : 175.00,
    "prodName" : "Ripgliders V.5",
    "prodDesc" : "A staple fashion piece for galesurfers worldwide, the Ripgliders V.5 introduces a Bluetooth-powered switch to toggle the pressure jets (alongside the manual switch located on the outer ankle of each skate), allowing for a seamless transition from galesurfing to walking, jogging, freerunning, or any other activity that powers your world. The Ripgliders also feature a concave cutout in the soles as part of our partnership with Soap!",
    "stock" : 654,
    "deckLength" : null,
    "skateSize" : ["Small", "Medium", "Large", "XL", "Wide"]
},
{
    "prodID" : 4,
    "prodType" : "Hoverboard",
    "prodPrice" : 225.00,
    "prodName" : "Mini Mantis V.2",
    "prodDesc" : "The Mini Mantis Hoverboard is the perfect gift to introduce the youngster in your life to the up-and-coming sport of galesurfing! Featuring a shorter deck length and our lower-power V4 engine, the Mini Mantis provides children with an exhilarating galesurfing experience while staying within children's safety regulations.",
    "stock" : 78,
    "deckLength" : 24,
    "skateSize" : null
},
